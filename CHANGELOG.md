...
- Set every Gradle lane to emit self-identifying release jars as `vsu-<minecraft-version>-<loader>-2.1.1.jar`; the release workflow now selects those names directly.
